      ...
      if(dragged){
        if (clicked) {
          ...
          hammer.on('pan pinch', function(ev) { 
            ...
            deltaX = ev.deltaX*currentScale;
            deltaY = ev.deltaY*currentScale;
            coorX = lastPosX*currentScale + deltaX;
            coorY = lastPosY*currentScale + deltaY;
            el.css({
            ...
            if (ev.isFinal) {
              ...
              el.css({
                transform: 'translate3d(' + coorX*1.2 + 'px, ' + coorY*1.2 + 'px, 0) scale(' + currentScale + ')'
              });
          ...
          hammer.on("pinchend", function (ev) {
            ...
            if (currentScale<minScale*1.5) {
              console.log(currentScale,minScale*1.5)
              el.css({
                transform: 'translate3d('+imgOffsetX+'px, '+imgOffsetY+'px, 0) scale(' + scale + ')'
              });
              $('#reczoom .t-slds__items-wrapper').attr('data-slider-stop', 'false');
