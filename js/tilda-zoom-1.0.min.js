        ...
        if (clicked) {
          ...
          hammer.on('pan pinch', function(ev) { 
            ...
            if (ev.isFinal) {
              ...
              if (coorX<coorMaxX*currentScale) {
                coorX=coorMaxX*currentScale;
                coorMaxX=coorX;
              }
              if (coorX>coorMinX*currentScale) {
                coorX=coorMinX*currentScale;
                coorMinX=coorX;
              }
              if (coorY<coorMaxY*currentScale) {
                coorY=coorMaxY*currentScale;
                coorMaxY=coorY;
              }
              if (coorY>coorMinY*currentScale) {
                coorY=coorMinY*currentScale;
                coorMinY=coorY;
              }
              el.css({
                transform: 'translate3d(' + coorX + 'px, ' + coorY + 'px, 0) scale(' + currentScale + ')'
