    ...
    if (allowZoom) {
      ...
      hammer.on('pinch', function(ev) {
        ...
        if (ev.pointers[0].clientX > ev.pointers[1].clientX) {
          x1 = ev.pointers[0].clientX - ev.pointers[1].clientX;
        } else {
          x1 = ev.pointers[1].clientX - ev.pointers[0].clientX;
        }
        if (ev.pointers[0].clientY > ev.pointers[1].clientY) {
          y1 = ev.pointers[0].clientY - ev.pointers[1].clientY;
        } else {
          y1 = ev.pointers[1].clientY - ev.pointers[0].clientY;
        }
        ...
        coorX = lastPosX*currentScale - x1*currentScale;
        coorY = lastPosY*currentScale - y1*currentScale;
        // console.log('x', x1)
        // console.log('y', y1)
        // console.log(dist)
        console.log(ev)
