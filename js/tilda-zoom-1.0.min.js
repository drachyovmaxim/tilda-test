    ...
    if (allowZoom) {
      ...
      hammer.on('pinchstart', function(ev) {
        ...
        if (ev.pointers[0].clientX > ev.pointers[1].clientX) {
          x1 = ev.pointers[0].clientX - (ev.pointers[0].clientX - ev.pointers[1].clientX)/2 - image.offset().left;
        } else {
          x1 = ev.pointers[1].clientX - (ev.pointers[1].clientX - ev.pointers[0].clientX)/2 - image.offset().left;
        }
        if (ev.pointers[0].clientY > ev.pointers[1].clientY) {
          y1 = ev.pointers[0].clientY - (ev.pointers[0].clientY - ev.pointers[1].clientY)/2 - (image.offset().top - element.offset().top);
        } else {
          y1 = ev.pointers[1].clientY - (ev.pointers[1].clientY - ev.pointers[0].clientY)/2 - (image.offset().top - element.offset().top);
        }
      });
      ...
      hammer.on('pinchmove', function(ev) {
        ...
        //   coorX = x1*currentScale - x1 + lastPosX*currentScale;
        // }

        // if (maxH>imageH*currentScale) {
        //   coorY = y1*currentScale - y1 + lastPosY*currentScale;
        // }
