  ...
  $('.zcontainer').each(function(index) {
    ...
    if (allowZoom) {
      ...
      hammer.on('pinch', function(ev) {
        ...
        // x1 = (ev.pointers[0].clientX + ev.pointers[1].clientX) / 2;
        // y1 = (ev.pointers[0].clientY + ev.pointers[1].clientY) / 2;

        coorX = lastPosX*currentScale - (x1/2)*currentScale;
        coorY = lastPosY*currentScale - (y1/2)*currentScale;
        // console.log('x', x1)
        // console.log('y', y1)
        // console.log(dist)
        console.log(ev)
