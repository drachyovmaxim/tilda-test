  ...
  $('.zcontainer').each(function(index) {
    ...
    if (allowZoom) {
      ...
      hammer.on('pinch', function(ev) {
        ...
        var dist = Math.sqrt((ev.pointers[0].clientX-ev.pointers[1].clientX) * (ev.pointers[0].clientX-ev.pointers[1].clientX) + (ev.pointers[0].clientY-e.touches[1].y) * (ev.pointers[0].clientY-ev.pointers[0].clientY));
