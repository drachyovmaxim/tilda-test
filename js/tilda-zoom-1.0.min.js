  ...
  $('.zcontainer').each(function(index) {
    ...
    if (allowZoom) {
      ...
      hammer.on('pinch', function(ev) {
        ...
        // coorX = lastPosX*currentScale + (imageW*currentScale)/2;
        // coorY = lastPosY*currentScale + (imageH*currentScale)/2;
        // coorX = maxW - imageW * currentScale + lastPosX / currentScale;
        // coorY = imageH * currentScale + lastPosY / currentScale;

        // (320-1680*.6)/-630/.6
        clickX = lastPosX - image.offset().left;
        clickY = lastPosY - (image.offset().top - element.offset().top);
        zoomedClickX = clickX*currentScale;
        zoomedClickY = clickY*currentScale;
        coorX = clickX - zoomedClickX + imgOffsetX;
        coorY = clickY - zoomedClickY + imgOffsetY;
        // console.log(ev)
        // console.log(ev.center.x, ev.deltaX)
        // console.log(ev.center.y, ev.deltaY)
        ...
        console.log(ev.center.pageX)
        console.log(ev.center.pageY)
