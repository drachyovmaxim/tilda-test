  ...
  $('.zcontainer').each(function(index) {
    ...
    if (allowZoom) {
      ...
      hammer.on('pinch', function(ev) {
        ...
        coorX = x * (imageW*currentScale - wwidth) / imageW*currentScale
        coorY = y * (imageH*currentScale - hheight) / imageH*currentScale
      ...
      hammer.on("pinchend", function (ev) {
        ...
        lastPosX = coorX;
        lastPosY = coorY;
        wwidth = imageW*currentScale;
        hheight = imageH*currentScale;
