function t_initZoom() {
  ...
  $('.zcontainer').each(function(index) {
    ...
    if (allowZoom) {
      ...
      var deltaX = 0;
      var deltaY = 0;
      var curW = coorX*adjustScale;
      var curH = coorY*adjustScale;
      ...
      hammer.on('pinch', function(ev) {
        ...
        coorX = clickX - clickX/currentScale + imgOffsetX;
        coorX = clickY - clickY/currentScale + imgOffsetY;
        console.log('pinch', clickX)
