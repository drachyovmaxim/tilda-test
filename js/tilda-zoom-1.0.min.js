  ...
  $('.zcontainer').each(function(index) {
    ...
    if (allowZoom) {
      ...
      hammer.on('pinch', function(ev) {
        ...
        coorY = lastPosY * currentScale + (maxW-imageW*currentScale)/2;
      ...
      //         deltaX = ev.deltaX;
      //         deltaY = ev.deltaY;
      //         www = (maxW-imageW*currentScale)/2;
      //         hhh = (maxH-imageH*currentScale)/2;
      //         if (ev.type == "pan") {
      //           coorX = lastPosX * currentScale + deltaX * currentScale;
      //           coorY = lastPosY * currentScale + deltaY * currentScale;
      //           console.log('pan')
      //         }
      //         if (ev.type == "pinch") {
      //           coorX = lastPosX * currentScale + www;
      //           coorY = lastPosY * currentScale + hhh;
      //           console.log('pinch')
      //         }
