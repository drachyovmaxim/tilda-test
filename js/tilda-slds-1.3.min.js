function t_sldsInit(recid) {
    ...
    if (oldIE == !0) {
        $('#rec' + recid).find('.t-slds__items-wrapper').removeClass('t-slds_animated-fast').removeClass('t-slds_animated-slow').addClass('t-slds_animated-none t-slds_ie')
    }
    var el = $('#rec' + recid),
        ...
        isPreview = el.find('.t-slds__items-wrapper').attr('data-slider-is-preview');
    ...
    if (oldIE == !0) {
        sliderWrapper.attr('data-slider-correct-height', 'true')
    }
...
function t_slds_ActiveCaption(recid, pos, totalSlides) {
    ...
    if (pos == 0) {
        // el.find('.t-slds__bullet[data-slide-bullet-for="' + totalSlides + '"]').addClass('t-slds__bullet_active')
        captionActive = el.find('.t-slds__caption[data-slide-caption="' + totalSlides + '"]');
    } else if (pos == totalSlides + 1) {
        // el.find('.t-slds__bullet[data-slide-bullet-for="1"]').addClass('t-slds__bullet_active')
