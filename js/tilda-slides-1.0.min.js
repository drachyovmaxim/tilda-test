...
function t_slides_setSliderHeight(recid) {
  var el = $('#rec'+recid);
  el.find('.t-slides__items-wrapper').css('max-height', el.find('.t-slides__item_active').height());
  el.find('.t-slides__arrow_wrapper').css('max-height', el.find('.t-slides__item_active').height());
}